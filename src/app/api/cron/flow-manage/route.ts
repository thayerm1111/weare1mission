...
const INTERVAL_MS = 2_000;  // re-check every ~2s (owner 09-09 "price watched and acted on
                            // faster") — with the parallel account prefetch a pass is
                            // short, so BE/partials land within ~2s of the trigger
