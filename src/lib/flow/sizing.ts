...
const MIN_STOP: Record<string, number> = {
  XAUUSD: 8.0,      // $8 on gold (~80 pips) — noise floor only. Owner 09-07: stops come from
                    // STRATEGY AND STRUCTURE, never a fixed default (the forced-$10 experiment
                    // is reverted; the structural stop rules are being redesigned in the audit)
  XAGUSD: 0.15,
