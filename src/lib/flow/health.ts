...
export type ComponentName = "manager" | "exec" | "genx" | "price_stream" | "genx3";
...
export const STALE_SEC: Record<ComponentName, number> = { manager: 120, exec: 210, genx: 420, price_stream: 3600, genx3: 120 };
