/** One-shot diagnostic replay for GENX 3.2.2 (PDMODE=LIVE|SHADOW for the PDH/PDL module) (same step32 as production) with Flow execution rules.
...
if (process.env.PDMODE) (CONFIG32.rules as Record<string, { mode: string }>).PDH_PDL_BREAK_RETEST_CONTINUATION.mode = process.env.PDMODE;
